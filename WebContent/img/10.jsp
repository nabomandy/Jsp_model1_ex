...
<form action="9.jsp" method="post" 
   ...
   <div class="wrap"> 
      <div class="inner_wrap">
         <div class="main">
            <div class="store">
            <%-- <% if (request.getParameter("brand_name").equals("BHC")){%>
               <img src="img/bhc.jpg" class="store_img" />
             <% else {%> --%>
             	<img src="img/<%=request.getParameter("imgname") %>" class="store_img" />
             	<%-- <%} %> --%>
               <div class="store_description">
                  <%=request.getParameter("name") %><br /> <br /> 최소주문금액<%=request.getParameter("minprice") %> <br /> <br /> 결제방법
               </div>
            </div>
  ...
  <div class="tab-content">
    <div id="home" class="container tab-pane active">
      ...
      <div class="cardbox">
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" /> sdf
                     </div>
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" /> sdf
                     </div>
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" />d
                     </div>
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" />ss
                     </div>
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" />
                     </div>
                     <div id="menu_card">
                        <img src="img/kyochon.jpg" class="menu_card_img" />
                     </div>
